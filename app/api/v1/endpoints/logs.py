...
def export_operation_logs(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.api.v1.endpoints.logs.export_operation_logs",
            request_body={
                "module": module,
                "operator_name": operator_name,
                "operator_ip": operator_ip,
...
def get_operation_log_detail(
    ...
    try:
        ...
        _record_operation_log(
            ...
            module_name="日志管理",
            business_type="query",
            class_method="app.api.v1.endpoints.logs.get_operation_log_detail",
...
def list_login_logs(
    ...
    try:
        ...
        _record_operation_log(
            ...
            module_name="日志管理",
            business_type="query",
            class_method="app.api.v1.endpoints.logs.list_login_logs",
            request_body={
                "username": username,
                "ip_address": ip_address,
                "statuses": statuses,
