...
def export_roles(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.api.v1.endpoints.roles.export_roles",
            request_body={
                "name": name,
                "role_key": role_key,
                "statuses": statuses,
...
def create_role(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.api.v1.endpoints.roles.create_role",
            request_body=body,
...
def update_role(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.api.v1.endpoints.roles.update_role",
...
def delete_role(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.api.v1.endpoints.roles.delete_role",
...
def change_role_status(
    ...
    try:
        ...
        _record_operation_log(
            ...
            current_user=current_user,
            business_type="update",
            class_method="app.api.v1.endpoints.roles.change_role_status",
            request_body=audit_body,
            response_body=response_payload,
            status=status,
            error_message=error_message,
