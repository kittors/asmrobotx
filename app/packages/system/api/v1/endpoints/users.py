...
from app.packages.system.api.v1.schemas.users import (
    UserCreateRequest,
...
def export_users(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.packages.system.api.v1.endpoints.users.export_users",
            request_body={
                "username": username,
                "statuses": statuses,
...
def download_template(
    ...
    try:
        ...
        _record_operation_log(
            ...
            current_user=current_user,
            business_type="export",
            class_method="app.packages.system.api.v1.endpoints.users.download_template",
            request_body=None,
...
def import_users(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.packages.system.api.v1.endpoints.users.import_users",
...
def create_user(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.packages.system.api.v1.endpoints.users.create_user",
            request_body=body,
            response_body=response_payload,
            status=status,
            error_message=error_message,
...
def update_user(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.packages.system.api.v1.endpoints.users.update_user",
...
def delete_user(
    ...
    try:
        ...
        _record_operation_log(
            ...
            class_method="app.packages.system.api.v1.endpoints.users.delete_user",
...
def reset_password(
    ...
    try:
        ...
        _record_operation_log(
            ...
            current_user=current_user,
            business_type="update",
            class_method="app.packages.system.api.v1.endpoints.users.reset_password",
            request_body={"user_id": user_id},
            response_body=response_payload,
            status=status,
            error_message=error_message,
